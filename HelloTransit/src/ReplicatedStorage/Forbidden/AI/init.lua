...
type SmartPathfindSettings = {StandardPathfindSettings: {}, Visualize: boolean, Tracking: boolean, SwapMovementMethodDistance: boolean, SMMD_RaycastParams: RaycastSettings, RetrackTimer: number, SkipToWaypoint: number}
