...
module.Visualize					= false		-- Visualizes the pathfinding algorithm.

-- Chase AI with hiding settings
module.LockerChase					= true				-- If true, the AI chases the player to the locker. (should it see them hide.)
